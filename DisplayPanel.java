...
public class DisplayPanel extends JPanel implements ActionListener {
	...
	public void addVehicle(Route r) {
		if (Math.random() < 0.85) {
			Vehicule newVoiture = new Voiture(r,( 0.12 + Math.random() * frame.getAggressivite() * 0.032)/4, 0.0000000001 + Math.random() * frame.getAggressivite() * 0.0000000001);
            ...
            Camion newCamion = new Camion(r,( 0.07 + Math.random() * frame.getAggressivite() * 0.032)/4, 0.00000000005 + Math.random() * frame.getAggressivite() * 0.00000000005);;
        	...
        	Moto newMoto = new Moto(r,( 0.1 + Math.random() * frame.getAggressivite() * 0.032)/4, 0.00000000015 + Math.random() * frame.getAggressivite() * 0.0000000001);;
