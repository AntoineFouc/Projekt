...
public class Limitation extends Obstacle implements Comparable<Obstacle> {
	...
	public void draw(Graphics g) {
		...
		if (route.getOrientation() == 270) {
			...
			g2d.drawString(String.valueOf((int)valeur), x - 30 + 8, 351 - 30 + 28);
		}
	}
